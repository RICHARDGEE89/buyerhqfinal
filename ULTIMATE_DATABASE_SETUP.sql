-- ============================================
-- BUYERHQ.COM.AU - ULTIMATE DATABASE SETUP
...
-- 2. SYNC EXISTING ADMIN ACCOUNTS
...
CREATE POLICY "Buyers can insert enquiries" ON public.enquiries 
