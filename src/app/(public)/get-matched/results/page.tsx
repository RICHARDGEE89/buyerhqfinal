            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-4xl mx-auto text-center space-y-6 mb-16">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full text-primary text-xs font-black uppercase tracking-widest border border-primary/20"
                    >
                    ...
                    {mockResults.length > 0 ? (
                        mockResults.map((agent, i) => (
                            <motion.div
                                ...
                                className="relative"
                            >
                                <div className="absolute -top-4 left-1/2 -translate-x-1/2 z-20 bg-gray-900 text-white px-6 py-2 rounded-2xl border-2 border-primary font-mono font-black text-xs shadow-xl flex items-center gap-2">
                ...
                <div className="mt-24 flex flex-col items-center gap-8">
                    <div className="flex flex-col sm:flex-row gap-6">
                        <Link href="/get-matched">
                            <Button variant="outline" className="h-16 px-10 rounded-[2rem] border-primary/20 text-white font-bold hover:bg-white hover:text-gray-900 transition-all">
                                <RefreshCcw className="w-4 h-4 mr-2" />
                                Redo Match Quiz
                            </Button>
                        </Link>
                        <Link href="/agents">
                            <Button className="h-16 px-12 bg-white text-gray-900 font-black rounded-[2rem] shadow-2xl hover:bg-primary hover:text-white transition-all text-lg">
                                Browse More Agents
                                <ArrowRight className="ml-2 w-5 h-5" />
                            </Button>
                        </Link>
                    </div>
                    <p className="text-white/20 text-[10px] font-mono font-bold uppercase tracking-[0.2em]">
