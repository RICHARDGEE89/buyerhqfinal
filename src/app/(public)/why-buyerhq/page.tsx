        ...
        <div className="bg-white min-h-screen">
            <section className="pt-40 pb-24 bg-topo relative overflow-hidden">
                <div className="container mx-auto px-6 relative z-10 space-y-8 max-w-4xl text-center">
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/5 border border-white/10 text-teal text-xs font-bold uppercase tracking-widest">
                        The BuyerHQ Advantage
                    </div>
                    <h1 className="text-5xl md:text-7xl font-display font-black text-white tracking-tight leading-tight">
                        Built for <span className="text-teal">Integrity.</span> <br />
                        Designed for <span className="text-teal">You.</span>
                    </h1>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-6">
                            <h2 className="text-4xl font-display font-black text-midnight tracking-tight">The difference <br /> is <span className="text-teal">Verification.</span></h2>
                        ...
                        <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl border border-stone/5 space-y-8">
                            ...
                            <Link href="/get-matched">
                                <Button className="w-full bg-teal text-white font-black h-16 rounded-2xl flex items-center justify-center text-lg shadow-xl shadow-teal/20">
