        ...
        <div className="bg-white min-h-screen">
            <section className="pt-40 pb-24 bg-topo relative overflow-hidden">
                <div className="container mx-auto px-6 relative z-10 space-y-8 max-w-4xl text-center">
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/5 border border-white/10 text-lime text-xs font-bold uppercase tracking-widest">
                        The BuyerHQ Advantage
                    </div>
                    <h1 className="text-5xl md:text-7xl font-display font-black text-white tracking-tight leading-tight">
                        Built for <span className="text-lime">Integrity.</span> <br />
                        Designed for <span className="text-lime">You.</span>
                    </h1>
                    <p className="text-xl text-white/60 leading-relaxed mx-auto max-w-2xl">
                            ...
                            <Card key={i} className="border-stone/5 rounded-[2.5rem] p-10 bg-white shadow-soft group hover:-translate-y-2 transition-all duration-500">
                                <CardContent className="p-0 space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-2xl font-display font-black text-midnight tracking-tight">{pillar.title}</h3>
            ...
            <section className="py-24 bg-warm/50 border-t border-stone/5">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-6">
                            <h2 className="text-4xl font-display font-black text-midnight tracking-tight">The difference <br /> is <span className="text-lime">Verification.</span></h2>
                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-3 text-midnight font-bold">
                        ...
                        <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl border border-stone/5 space-y-8">
                            <h4 className="text-xl font-display font-black text-midnight">Ready to find your expert?</h4>
                            ...
                            <Link href="/get-matched">
                                <Button className="w-full bg-lime text-white font-black h-16 rounded-2xl flex items-center justify-center text-lg shadow-xl shadow-teal/20">
