            ...
            <div className="container mx-auto px-6 max-w-6xl">
                <div className="text-center space-y-4 mb-20 max-w-3xl mx-auto">
                    ...
                    <h1 className="text-5xl md:text-7xl font-display font-black text-midnight tracking-tight">
                        Buyer <span className="text-lime">Intelligence.</span>
                    </h1>
                            ...
                            <CardContent className="p-0">
                                ...
                                <div className="p-10 space-y-6">
                                    <div className="flex items-center gap-4 text-[10px] font-mono font-bold text-stone uppercase tracking-widest">
                                        <span className="text-lime border-b-2 border-lime pb-1">{post.category}</span>
                                        <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> {post.readTime}</span>
                                    </div>
                                    <h3 className="text-2xl font-display font-black text-midnight tracking-tight leading-tight group-hover:text-lime transition-colors">
                                        {post.title}
                                    </h3>
                                    <p className="text-stone font-medium leading-relaxed line-clamp-2 italic">
                                        &quot;{post.excerpt}&quot;
                                    </p>
                                    <Button variant="ghost" className="p-0 text-midnight font-black flex items-center gap-2 hover:bg-transparent hover:text-lime group/btn">
