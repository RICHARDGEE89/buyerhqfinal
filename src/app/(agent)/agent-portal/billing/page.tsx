            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div className="space-y-2">
                    <h1 className="text-4xl font-display font-black text-midnight tracking-tight">
                        Billing & <span className="text-teal">Subscription</span>
                    </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-8">
                        ...
                        <CardContent className="p-10 md:p-14 space-y-10 relative z-10">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                <div className="space-y-4">
                                    <Badge className="bg-teal text-white border-transparent font-black px-4 py-1.5 rounded-xl uppercase tracking-widest text-[10px]">
                                        Current Plan
                                    </Badge>
                            ...
                            <div className="flex flex-wrap gap-4 pt-10">
                                <Button className="bg-white text-midnight font-black px-10 h-14 rounded-2xl hover:bg-teal hover:text-white transition-all shadow-xl">
                                    Change Plan
                                </Button>
                                <Button variant="ghost" className="text-white/40 hover:text-amber hover:bg-amber/5 rounded-2xl p-4 h-14">
                                    Cancel Subscription
                                </Button>
                            </div>
                        </CardContent>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="border-stone/10 rounded-[2.5rem] bg-white p-8 group hover:border-teal/30 transition-all shadow-soft">
                            <div className="flex items-center justify-between">
                                ...
                                <Button variant="ghost" className="text-teal font-bold text-sm hover:underline">
                                    Update
                                </Button>
                            </div>
                        </Card>
                        ...
                        {invoices.map((inv) => (
                            <Card key={inv.id} className="border-stone/10 rounded-3xl bg-white p-6 hover:shadow-sm transition-all shadow-soft">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Button variant="ghost" size="icon" className="w-10 h-10 rounded-xl bg-warm/50 text-stone hover:text-teal transition-all">
