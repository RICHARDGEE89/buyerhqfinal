...
export default function AgentDashboardOverview() {
    const metrics = [
        { label: 'Total Leads', value: '124', icon: Users, trend: '+12%', trendUp: true, color: 'text-ocean bg-ocean/10' },
        ...
        { label: 'Match Rate', value: '72%', icon: Sparkles, trend: '+8%', trendUp: true, color: 'text-amber bg-amber/10' },
    ];
    ...
    return (
        <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div className="space-y-2">
                    <h1 className="text-4xl font-display font-black text-midnight tracking-tight">
                        Dashboard <span className="text-ocean">Overview</span>
                    </h1>
                ...
                <div className="flex gap-4">
                    ...
                    <Button className="bg-midnight hover:bg-ocean text-white font-black h-12 px-8 rounded-xl transition-all shadow-lg">
                        Manage Profile
                    </Button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {metrics.map((m) => (
                    <Card key={m.label} className="border-stone/5 rounded-[2.5rem] bg-white shadow-soft group hover:border-ocean/30 transition-all">
                        <CardContent className="p-8 space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <div className={cn(
                                    ...
                                    m.trendUp ? "text-verified underline decoration-verified/20" : "text-coral underline decoration-coral/20"
                                )}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/agent-portal/leads" className="text-ocean font-bold text-sm hover:underline flex items-center gap-2">
                            View all leads <ChevronRight className="w-4 h-4" />
                        </Link>
                    </div>
                    <div className="space-y-4">
                        {recentLeads.map((lead) => (
                            <Card key={lead.id} className="border-stone/5 rounded-[2.5rem] bg-white shadow-sm overflow-hidden group hover:border-ocean/20 transition-all">
                                <CardContent className="p-8 flex items-center justify-between">
                                    <div className="flex items-center gap-6">
                                        <div className="w-14 h-14 rounded-2xl bg-warm flex items-center justify-center font-display font-black text-ocean">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className={cn(
                                                    ...
                                                    lead.status === 'new' ? "bg-ocean/10 text-ocean border-ocean/20" : "bg-stone/5 text-stone border-stone/10"
                                                )}>
                                                    {lead.status}
                                                </div>
                                            </div>
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <Button variant="ghost" size="icon" className="bg-warm/50 hover:bg-ocean hover:text-white transition-all rounded-xl w-12 h-12">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <Card className="border-stone/5 rounded-[2.5rem] bg-midnight text-white p-8 space-y-6 shadow-xl relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-ocean/20 rounded-full blur-3xl -mr-16 -mt-16" />
                            <div className="space-y-2 relative z-10">
                                <div className="w-10 h-10 bg-ocean rounded-xl flex items-center justify-center mb-4">
                            ...
                            <Button className="w-full bg-white text-midnight font-black rounded-xl h-12 hover:bg-ocean hover:text-white transition-all">
                                Add Video Now
                            </Button>
                        </Card>
