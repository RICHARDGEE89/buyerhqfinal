                ...
                <Card className="bg-white rounded-[3rem] p-10 md:p-12 shadow-2xl border border-stone/5 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-right">
                            <Link href="#" className="text-xs font-bold text-ocean hover:underline">Forgot password?</Link>
                        </div>
                    </div>

                    <Button className="w-full h-16 bg-midnight hover:bg-ocean text-white font-black rounded-2xl shadow-xl transition-all text-lg group">
                        Sign In
                    ...
                    <div className="text-center pt-4">
                        <p className="text-stone text-xs font-medium">
                            ...
                            <Link href="/signup" className="text-ocean font-bold hover:underline">Sign up for free</Link>
                        </p>
                    </div>
                </Card>
