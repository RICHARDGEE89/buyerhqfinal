...
const FeatureRow = ({ icon: Icon, text }: { icon: React.ElementType, text: string }) => (
    <div className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-stone/5 shadow-sm">
        <div className="w-10 h-10 rounded-xl bg-sky flex items-center justify-center text-ocean">
                    ...
                    <div className="space-y-10">
                        <div className="space-y-4">
                            <h2 className="text-4xl md:text-5xl font-display font-black tracking-tight leading-tight text-midnight">
                                ...
                                <span className="text-ocean">Home Buyers.</span>
                            </h2>
                    ...
                    <div className="space-y-10 bg-warm/50 p-10 md:p-16 rounded-[3rem] border border-stone/5">
                        <div className="space-y-4">
                            <h2 className="text-4xl md:text-5xl font-display font-black tracking-tight leading-tight text-midnight text-left">
                                ...
                                <span className="text-ocean">as an Expert.</span>
                            </h2>
                            <p className="text-lg text-stone font-medium leading-relaxed max-w-lg">
                        ...
                        <div className="pt-4">
                            <Link href="/join">
                                <Button variant="outline" className="border-stone/20 text-midnight hover:bg-white hover:border-ocean transition-all font-bold h-14 px-10 rounded-2xl text-lg w-full sm:w-auto">
                                    List Your Profile
                                </Button>
                            </Link>
                        </div>
