...
export const SearchBar = ({ className }: { className?: string }) => {
    ...
    return (
        <div className={cn("relative w-full max-w-3xl mx-auto group", className)}>
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-ocean to-indigo-600 rounded-[2.5rem] blur opacity-20 group-hover:opacity-40 transition-opacity duration-500" />
            ...
            >
                ...
                <div className="flex items-center gap-2">
                    <Button
                        type="button"
                        variant="ghost"
                        className="hidden lg:flex items-center gap-2 text-stone hover:text-ocean transition-colors font-bold px-4"
                    >
                    ...
                    <Button
                        type="submit"
                        className="h-14 px-8 bg-ocean hover:bg-ocean/90 text-white text-lg font-bold rounded-2xl shadow-lg shadow-ocean/20 transition-transform active:scale-95 flex items-center gap-2"
                    >
