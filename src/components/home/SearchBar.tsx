            ...
            >
                <div className="flex-1 flex items-center px-4 gap-3 border-b sm:border-b-0 sm:border-r border-stone/5 py-3 sm:py-0">
                    ...
                    <input
                        ...
                        className="w-full bg-transparent border-none focus:outline-none text-gray-900 font-medium placeholder:text-stone/50 text-lg"
                        value={query}
                ...
                <div className="flex items-center gap-2">
                    <Button
                        type="button"
                        variant="ghost"
                        className="hidden lg:flex items-center gap-2 text-stone hover:text-primary transition-colors font-bold px-4"
                    >
                    ...
                    <Button
                        type="submit"
                        className="h-14 px-8 bg-primary hover:bg-primary/90 text-white text-lg font-bold rounded-2xl shadow-lg shadow-teal/20 transition-all active:scale-95 flex items-center gap-2"
                    >
