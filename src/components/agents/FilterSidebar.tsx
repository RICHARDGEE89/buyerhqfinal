        ...
        <aside className="space-y-8 w-full">
            ...
            <Card className="border-stone/10 rounded-[2rem] overflow-hidden sticky top-24">
                <CardContent className="p-8 space-y-10">
                        ...
                        <div className="space-y-3">
                            <label className="flex items-center justify-between p-3 rounded-xl bg-verified/5 border border-verified/10 cursor-pointer group">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm font-bold text-midnight group-hover:text-verified transition-colors">Verified Only</span>
                                </div>
                        ...
                        <div className="space-y-3">
                            {specializations.map((spec) => (
                                <label key={spec} className="flex items-center gap-3 cursor-pointer group">
                                    <Checkbox id={spec} />
                                    <span className="text-sm font-medium text-stone group-hover:text-midnight transition-colors">{spec}</span>
                                </label>
                            ))}
                        </div>
                    </div>
                    ...
                    <Button className="w-full bg-midnight text-white font-black h-12 rounded-xl">
                        Apply Refinements
                    </Button>

                    <Button variant="ghost" className="w-full text-stone hover:text-midnight font-bold">
                        Clear All Filters
                    </Button>
